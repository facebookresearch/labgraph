...
class Delsys():
    ...
    def __init__(self):
        ...
        self.license = "<License>"\
            ...
            "<Customer>"\
            "<Name>Yu Bicer</Name>"\
            "<Email>biceryu@gmail.com</Email>"\
            "</Customer>"\
            "<Expiration>Wed, 01 Jan 2031 05:00:00 GMT</Expiration>"\
            "<Signature>MEUCICTyzglHLhoh3rCOAvzVWE6jjKQKgQjOkRply/NaexBfAiEArrJz3zg8C98YCTGHtk8SmCiQ+u6P7Oy8OlKBULqVmHY=</Signature>"\
            "</License>"
