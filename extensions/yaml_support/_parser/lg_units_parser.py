...
class LabGraphUnitsParser(BaseParser, NodeVisitor, Generic[T]):
    ...
    def visit_ClassDef(self, node) -> None:
        ...
        if node.bases and base_type in set(unit.value for unit in LabGraphBuiltinUnits):    
    ...
    def __construct_type(self,value,type):
        ...
        Args:
            ...
            value : an object that contains data about the type of the class member/method
        """
